::: {.callout-problem title="Station card: Conservation Laws (Orbits) (6–8 minutes)"}
...
**Word bank:**
- **Speed factor ($v/v_{\rm circ}$):** speed compared to circular speed at the same $r_0$.
...
**Sanity checks:**
- Escape happens at $v_{\rm esc}=\sqrt{2}\,v_{\rm circ}$ (so speed factor $\approx 1.414$), regardless of direction.
