...
**Demo setup:** open `/demos/em-spectrum/`, start in **Visible**.
...
1. In one paragraph: explain why we need space telescopes for UV/X-ray/gamma astronomy but can do much of radio astronomy from the ground.
2. Describe the difference between “higher-energy photons” and “brighter light” using an example from the demo.
3. The visible band is narrow. What does that imply about what our eyes can and cannot tell us about the Universe?
4. Choose one object from the demo’s **Objects** tab and explain why it is best observed in the band(s) listed.

## Exit ticket (3 questions)

1. If wavelength increases, what happens to frequency? (One sentence.)
2. Which has higher photon energy: infrared or ultraviolet? (One sentence.)
3. Name one reason astronomers build different telescopes for different wavelength bands.
