...
::: {.callout-deep-dive title="Earth–Moon distance presets in the student demo" collapse="true"}
...
::: {.callout-deep-dive title="Thresholds at student distance presets (computed by the model)" collapse="true"}
