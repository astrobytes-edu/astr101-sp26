...
::: {.callout-deep-dive title="Single source of truth (testable model)" collapse="true"}
...
::: {.callout-sanity-check title="Geometry sanity checks"}
...
::: {.callout-sanity-check title="Timing sanity checks"}
...
::: {.callout-deep-dive title="Units and the 101 vs 201 toggle" collapse="true"}
Internally:
...
::: {.callout-deep-dive title="Intentional simplifications" collapse="true"}
