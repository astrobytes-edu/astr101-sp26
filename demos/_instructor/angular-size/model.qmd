...
::: {.callout-sanity-check title="Dimensional analysis"}
...
::: {.callout-deep-dive title="Numbers implied by the demo’s orbit range" collapse="true"}
...
::: {.callout-deep-dive title="Why this is a ‘toy’ model" collapse="true"}
