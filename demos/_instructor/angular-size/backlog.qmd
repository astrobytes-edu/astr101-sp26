...
|---|---|---|---|---|---|
| P0 | High | Low | UX | Add explicit “internal units = km” label near sliders to prevent silent unit errors. | `demos/angular-size/index.html` |
| P0 | High | Medium | Physics | Add a “total vs annular” note tied to Moon distance (connect to eclipse demo’s umbra/antumbra idea). | `demos/angular-size/angular-size.js` + instructor docs |
