...
::: {.callout-tps title="TPS: Does the Sun move?"}
...
::: {.callout-problem title="Investigation: Mass ratio and orbit size"}
...
::: {.callout-problem title="Astro Lab: Exoplanet Detection Simulation"}
...
::: {.callout-problem title="Astro Lab: Period and Mass Relationship"}
...
2) **Rule:** Write a formula relating orbit sizes to masses.

3) **Prediction:** If you doubled Jupiter's mass, what would happen to the Sun's wobble?

4) **Exoplanet connection:** How would an astronomer detect a Jupiter-sized planet around a distant star using only the star's light?
...
::: {.callout-deep-dive title="Demo: Why both bodies move" collapse="true"}
...
::: {.callout-deep-dive title="Demo: Stellar wobble for exoplanet detection" collapse="true"}
