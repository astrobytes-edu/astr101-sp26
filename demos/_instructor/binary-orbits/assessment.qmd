...
- Student demo: [/demos/binary-orbits/](/demos/binary-orbits/)
...
::: {.callout-check-yourself title="Clicker 1: Who orbits whom?"}
...
::: {.callout-check-yourself title="Clicker 2: Mass ratio and orbit size"}
...
::: {.callout-check-yourself title="Clicker 3: Barycenter position"}
...
::: {.callout-check-yourself title="Clicker 4: Orbital period relationship"}
...
::: {.callout-problem title="Short answer 1: Exoplanet detection"}
...
::: {.callout-problem title="Short answer 2: Mass determination in binary stars"}
...
::: {.callout-problem title="Short answer 3: Period scaling (ASTR 201)"}
...
::: {.callout-check-yourself title="Exit ticket: Why does the Sun wobble?"}
...
::: {.callout-check-yourself title="Exit ticket: Inverse relationship"}
...
::: {.callout-problem title="Diagnosis: Where is the barycenter?"}
...
::: {.callout-problem title="Diagnosis: Different periods?"}
