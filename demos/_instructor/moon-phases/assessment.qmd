---
title: "Moon Phases — Assessment Bank"
...
- Student demo: [/demos/moon-phases/](/demos/moon-phases/)
...
::: {.callout-check-yourself title="Clicker 1: What causes phases?"}
**Prompt:** What is the main cause of Moon phases?
...
::: {.callout-check-yourself title="Clicker 2: ‘Quarter’ means…"}
**Prompt:** “First Quarter” is called “quarter” because…
...
::: {.callout-check-yourself title="Clicker 3: New Moon is not ‘unlit’"}
**Prompt:** At New Moon, which statement is true?
...
::: {.callout-problem title="Short answer 1: Two halves story"}
**Prompt (2–3 sentences):** Explain phases using the ideas “illuminated half” and “visible half.” Your explanation must state why the lit half does not change.
...
::: {.callout-problem title="Short answer 2: A quick calculation"}
**Prompt:** The demo uses $f=\frac{1+\cos\alpha}{2}$ for illumination fraction. If $\alpha=60^\circ$, what is $f$?
...
::: {.callout-check-yourself title="Exit ticket: Eclipse connection"}
**Prompt:** During which phase can a **lunar eclipse** happen (in principle)?
