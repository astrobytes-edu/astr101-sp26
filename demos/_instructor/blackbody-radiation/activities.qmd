...
**Artifact:** a “temperature–spectrum card.”

At the station, students pick one preset (**Sun**, **Red Giant**, **B**, **White Dwarf**) and fill in:
- $T$ (K)
- $\lambda_{\text{peak}}$ (nm or µm)
- Which band dominates (IR / visible / UV)
- One sentence: “This star looks ____ because its blackbody peak is at ____.”
