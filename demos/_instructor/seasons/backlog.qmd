...
|---|---|---|---|---|---|
| P0 | High | Low | UX | Add explicit “Not to scale” label for the orbit exaggeration and distance axis. | `demos/seasons/index.html` |
| P0 | High | Medium | Physics | Use one consistent year length everywhere (switch calendar wrap logic from 365 to 365.2422 or explicitly label “calendar day-of-year” vs “solar longitude”). | `demos/seasons/seasons.js` + `demos/_assets/seasons-model.js` |
...
| P2 | Medium | Low | Accessibility | Add a reduced-motion mode that defaults animations to step mode. | `demos/seasons/seasons.js` |
