...
::: {.callout-deep-dive title="Model parameters as implemented" collapse="true"}
...
::: {.callout-sanity-check title="Declination sanity checks"}
...
::: {.callout-sanity-check title="Day-length sanity checks"}
...
::: {.callout-sanity-check title="Noon-altitude sanity checks"}
...
::: {.callout-deep-dive title="What’s simplified / not modeled" collapse="true"}
