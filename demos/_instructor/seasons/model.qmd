...
From `demos/seasons/seasons.js` (calendar and distance display):

- Calendar year length used for date wrapping: `YEAR_DAYS = 365` (days; non-leap-year calendar)
- Eccentricity used for distance display: `e ≈ 0.017` (dimensionless)
- Perihelion day anchor: `day ≈ 3` (≈ Jan 3)
...
$$r \approx 1 - e\cos\!\left(2\pi\,\frac{(\text{dayOfYear}-3)}{365}\right)$$
