...
<!--
TODO (high priority):
- Confirm Midterm 1 and Midterm 2 dates (and whether in-class vs evening)
- Confirm grading weights for Spring 2026 (table below may need adjustment)
- Finalize/replace the AI policy section with your official ASTR201 version (if desired)

Compilation/Rendering (from the folder containing this file):

Render both HTML + PDF (recommended):
...
Live preview while editing:
  quarto preview syllabus.qmd

If PDF rendering fails due to missing LaTeX:
...
| **Location** | LH 245 |
| **Course website** | <https://astrobytes-edu.github.io/astr201-sp26> (TBD) |
| **Platforms:** <br>*(where things happen)* | [Canvas](https://sdsu.instructure.com) *(announcements, submissions, gradebook)*<br>[Course website](https://astrobytes-edu.github.io/astr201-sp26) *(course materials, handouts, assignments)*<br>iClicker *(in-class engagement)* |
...
*Important:* This is a **quantitative** course, but the goal is not rote memorization or “plug-and-chug.” You will use math as a tool to build **physical understanding and intuition** — what an equation means, what assumptions it hides, and how to sanity-check results (units, limits, scaling). Since ASTR 201 is required for Astronomy pre-majors, it is also designed to prepare you for **upper-division Physics and Astronomy courses** by strengthening your habits of scientific modeling, quantitative reasoning, and clear scientific explanation.

::: {.callout-note icon=false}
## Core Course Throughline: Modern Astronomy = Astrophysics

Modern astronomy *is* astrophysics: we use physics (and math) to infer what the Universe is made of and how it works from limited measurements. We observe (usually photons) and build simplified physical models and quantify uncertainty to test whether the model can explain astrophysical phenomena based on what we measured.
:::

### Required Materials

- **Required textbook:** Stan Owocki, *Fundamentals of Astrophysics*, **2nd Edition** ([Cambridge University Press](https://www.cambridge.org/9781009618007)). **ISBN:** 9781009618007 (paperback)
...
### Generative AI (ChatGPT, Gemini, etc.) {#sec-generative-ai}
