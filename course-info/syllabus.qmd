...
- **In class:** Bring iClicker; most Fridays include activities
...
**Classroom norms:** Phones and off-task devices are not permitted during class. Be punctual. Respect your classmates and contribute to our learning community.
...
**ASTR 101 NotebookLM** — A private notebook grounded in course materials only (invitation via Canvas). Use for reviewing concepts, not generating solutions.
:::
...
**Do not use** ChatGPT, Gemini, Claude, or similar tools to produce, rewrite, or "polish" anything you submit. These tools can generate fluent explanations that are subtly wrong — and in a quantitative course, "sounds right" isn't a standard of truth.
