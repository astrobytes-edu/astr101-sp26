...
*Solutions are available in the [Lecture 21 Solutions](lecture-21-neutron-stars-black-holes-solutions.qmd).*
...
1. **Tidal Forces and Spaghettification**: Near the event horizon of a black hole, the gravitational acceleration varies strongly with distance. For a non-rotating (Schwarzschild) black hole, the tidal acceleration (difference in gravity between two points separated by distance $\Delta r$) is approximately
   $$
   a_{\text{tidal}} \approx \frac{2GM\Delta r}{r^3}.
   $$
   Consider a human falling feet-first into a $10\,M_\odot$ black hole.
