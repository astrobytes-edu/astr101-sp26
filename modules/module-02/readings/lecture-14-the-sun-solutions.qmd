...
**Equation:**
$$
\Delta m = m_{\rm initial} - m_{\rm final}, \qquad E = \Delta m c^2
$$
...
**Equation:**
$$
\rho = nm_p, \qquad P = \frac{1}{2}\rho v^2
$$
...
**Given:**
- Hydrogen consumption rate: $600$ million metric tons/s
- Solar mass: $M_\odot \approx 2 \times 10^{30}\ \text{kg}$
- Approximate fraction available for core hydrogen fusion: $\sim 10\%$

**Find:** The Sun's main-sequence lifetime

**Equation:**
$$
t \sim \frac{M_{\rm available}}{\dot M}
$$
