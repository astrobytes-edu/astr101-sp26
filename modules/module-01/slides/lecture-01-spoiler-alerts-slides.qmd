    ...
    include-after-body:
      text: |
        ...
        document.addEventListener('DOMContentLoaded', function() {
          ...
          qrDiv.innerHTML = `
            <img src="/assets/iClicker_Course_QRCode-ASTR101.png" width="280" style="border: 2px solid white; border-radius: 4px;">
            <div style="font-size: 3em; color: black; margin-top: 0.5rem; font-weight: bold;">
              <a href="https://join.iclicker.com/ASES" target="_blank" style="color: black; text-decoration: underline; cursor: pointer;">join.iclicker.com/ASES</a>
            </div>
          `;
...
<!----------------------------------------------------------------------------
  ...
  Goal: Capture attention and create wonder
----------------------------------------------------------------------------->
...
::: {.flex .flex-col .w-full .pt-2 style="height: 65vh;"}
...
Made from over 1,100 images captured by NSF-DOE Vera C. Rubin Observatory.

Begins with two galaxies, zooms out to reveal 10 million galaxies—roughly 0.05% of the 20 billion Rubin will capture.
...
::: {.fragment .text-sm}
You just saw **10 million galaxies** — and that's only 0.05% of what one telescope will find.
:::
:::
...
<!----------------------------------------------------------------------------
  PART 2: THE COURSE PROMISE (8 min)
  Goal: Establish the course thesis and framework
----------------------------------------------------------------------------->
...
::: {.text-center .text-xl .font-semibold .mt-4}
[Pretty pictures → measurements → models → inferences]{.rn rn-type="underline" rn-color="#5dbfbf"}
:::

::: {.fragment .bg-muted .p-2 .mt-4}
**What this means:**
...
::: {.bg-muted .p-2 .mt-4}
**The constraint:** We can only study the light that reaches us.

- No thermometers in the Sun
- No tape measures to galaxies
- No scales to weigh stars
...
<!----------------------------------------------------------------------------
  PART 3: THE FOUR OBSERVABLES (10 min)
  Goal: Establish that only 4 things can be directly measured
----------------------------------------------------------------------------->

## What Can We Actually Measure? {background-color="black"}
...
::: {.fragment .bg-muted .p-2 .mt-4}
::: {.incremental}
1. **How bright?** — brightness (energy per second per area)
...
<!----------------------------------------------------------------------------
  PART 4: THE SPOILER REEL (20 min)
  Goal: Show the Measure → Infer → Physics pattern repeatedly
----------------------------------------------------------------------------->
...
Same pattern every time: **Observable → Model → Physical Reality**
:::

::: {.notes}
14–15 min.

Orientation: "This is the repeatable structure for the whole course. I'm going to show you 6 examples. For each one, ask yourself: what did we measure, and what did we conclude?"
:::

---

## Spoiler 1: Nebulae — Colors Are Chemistry {background-color="black"}
...
## Spoiler 3: The Distance Ladder {background-color="black"}
...
**The physics:** Light spreads out as it travels — if you know the true brightness, you can calculate distance
:::

::: {.fragment .text-sm .text-muted .mt-2}
*A dim nearby source can look identical to a bright distant one — physics breaks the tie.*
:::
...
If you know how bright something *actually is* (luminosity), and you measure how bright it *appears* (flux), you can calculate distance.
...
- Exploding white dwarfs (same mass → same brightness)
:::
...
## Spoiler 6: The Dark Universe {.compact background-color="black"}
...
::: {.column width="40%"}
::: {.bg-muted .text-sm}
**We measure:** How fast galaxies are moving (from wavelength shifts)

**We infer:** There must be more mass than we can see — "dark matter"

**The physics:** Gravity connects orbital speed to mass. Fast motion requires more gravity, which requires more mass.
:::

::: {.fragment .text-center .text-sm .text-muted .mt-2}
Only ~5% of the universe is ordinary matter. The rest is invisible.
:::
...
"We measure velocities using wavelength shifts — the Doppler effect. When we calculate how much mass is needed to explain those speeds, we get 5-6 times more mass than the stars and gas we can see."

Cosmic recipe: 5% atoms, 27% dark matter, 68% dark energy.

"We don't know what most of the universe is made of. That's not a failure — that's a frontier."
:::

---

## Spoiler Synthesis: The Pattern Repeats {background-image="/assets/images/module-01/universe-history-nasa.png" background-opacity="0.2"}
...
<!----------------------------------------------------------------------------
  PART 5: TWO BIG IDEAS (5 min)
  Goal: Establish lookback time and wavelength-energy connection
----------------------------------------------------------------------------->
...
<!----------------------------------------------------------------------------
  ...
  Goal: Consolidate and preview next time
----------------------------------------------------------------------------->
