...
::: {.fragment .mt-2 .text-xs .text-muted}
...
$$\theta = \frac{D}{d} \quad \text{(radians)}$$
...
- Angular size: $\theta = 57.3° \times \frac{3474}{384{,}000} = 57.3° \times 0.00905$
...
- [x] The ratio of their diameters equals the ratio of their distances
...
- Work through the **Check Yourself** questions
...
## Questions? {background-image="/assets/images/common/noirlab-nightsky-mosaic.jpg" background-opacity="0.3"}

::: {.text-center .text-lg}
What's still unclear?

What would help it click?
:::
