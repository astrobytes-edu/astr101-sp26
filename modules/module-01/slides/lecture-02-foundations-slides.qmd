...
::: {.fragment}
**Pro tip:** Parentheses are your best friend—wrap the whole unit before raising to a power.
:::

::: {.notes}
2 min. This is a classic student trap. Show the trap first, ask "what's wrong here?" Give them 10 seconds. Then reveal the right way. Walk through slowly. Emphasize: a cubic meter is a cube with sides of 100 cm each, so the volume is $100 \times 100 \times 100$.
:::
