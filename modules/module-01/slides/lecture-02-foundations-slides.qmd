...
::: {.columns}
::: {.column width="55%"}
A light-year is **not** a time—it's a **distance**.
...
Because saying "Proxima Centauri is $4 \times 10^{16}$ meters away" is painful.

Saying "4.2 light-years" is memorable.
:::
:::
:::

::: {.fragment}
When we say a star is 100 light-years away, we're also saying we see it **as it was 100 years ago**.
:::

::: {.notes}
1 min. Reinforce the light-year misconception. Distance = time dial is the key insight.
Connect to the opening theme: we see the past, not the present.
:::
