...
## {background-image="/assets/images/module-01/logarithmic-cosmic-scales-gemini.webp" background-size="contain" background-color="#0a0a14"}
...
- **Gravitational constant:** $G = 6.674 \times 10^{-11}$ m³/(kg·s²) — how strong gravity is
...
- Need: $G = 6.674 \times 10^{-11}\,\text{N}\cdot\text{m}^2/\text{kg}^2$, mass, radius...
...
Note: Mars is cold (−60°C average) mainly due to its thin atmosphere (~1% of Earth's), not just distance. But less sunlight does mean solar panels must be larger.
:::
