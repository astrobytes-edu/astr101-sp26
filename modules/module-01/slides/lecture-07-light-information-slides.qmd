...
::: {.incremental .text-sm}
- Describe light as an **electromagnetic wave** ($c = \lambda f$)
...
All light travels at the same speed: $c = 3 \times 10^8\ \mathrm{m/s}$
:::
...
Without doing math: if the wavelength doubles ($\lambda \to 2\lambda$), the frequency $f$ becomes...
...
1. Light is an electromagnetic wave: $c = \lambda f$.
...
::: {.notes}
  "The relationship is inverse. As $\lambda$ decreases, $f$ increases proportionally."
:::
