...
::: {.column width="64%"}
{{< img em-spectrum-full width="100%" >}}
:::
...
Different wavelength bands trace different physics.
:::
:::
::::
...
::: {.notes}
8 min. Reinforce why astronomy uses multiple telescope platforms.
:::
...
:::: {.columns .v-center-container}
::: {.column width="64%"}
{{< img light-matter-interactions width="100%" >}}
:::
...
::: {.notes}
8–9 min. Use this as the bridge from spectrum bands to measurable signatures.
:::
...
:::: {.columns .v-center-container}
::: {.column width="64%"}
{{< img types-of-spectra-jwst width="100%" >}}
:::
...
::: {.notes}
9 min. This replaces the table with image-first interpretation.
:::
...
:::: {.columns .v-center-container}
::: {.column width="64%"}
{{< img absorption-emission-spectra-jwst width="100%" >}}
:::
...
::: {.notes}
9–10 min. Set up Lecture 8/9 spectroscopy logic with a concrete visual.
:::
...
{{< img prism-spectrum-jwst width="78%" >}}
...
{{< img rayleigh-scattering-gemini width="90%" >}}
...
::: {.notes}
16 min. Tie model diagram to observed sky behavior.
:::
