...
- $G = 6.674 \times 10^{-11}\ \mathrm{N\,m^2/kg^2}$ (gravitational constant)
...
$$
v = \sqrt{\frac{(6.674 \times 10^{-11})(2 \times 10^{30})}{1.5 \times 10^{11}}} \approx 29{,}800 \text{ m/s} \approx 30 \text{ km/s}
$$
...
*Solutions are available in the [Lecture 6 Solutions](lecture-06-newtons-gravity-solutions.qmd).*
