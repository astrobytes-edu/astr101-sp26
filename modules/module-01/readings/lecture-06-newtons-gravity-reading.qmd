...
If $L$ stays constant and $r$ gets smaller, $v_t$ must get larger. **Closer → faster. Farther → slower.**
...
3. Drag the **M₁** slider to 2.0 M☉ (now 2 + 1 = 3 M☉ total)
...
The [Kepler's Laws Demo](https://astrobytes-edu.github.io/astr101-sp26/demos/keplers-laws/) has a **NEWTON MODE** button that shows velocity and acceleration vectors. Try it to see how centripetal acceleration always points toward the Sun.
:::
