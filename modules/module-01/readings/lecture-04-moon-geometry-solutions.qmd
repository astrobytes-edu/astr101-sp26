...
**Important note:** This estimate assumes the $2.4$ eclipses/year in the prompt correspond to eclipses with a comparable path of totality. In reality, not every solar eclipse is total, and totality paths vary in size — so treat this as an order-of-magnitude inference from rates.
