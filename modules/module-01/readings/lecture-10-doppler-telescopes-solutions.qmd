...
This unseen mass is called **dark matter**. It doesn't emit, absorb, or reflect light (hence "dark"), but it exerts gravitational influence. Observations suggest that dark matter constitutes about 85% of all matter in the universe.
...
**What you should learn from this:** Dark matter is not a speculation — it's an inference from Doppler measurements and Newtonian gravity. The same tools (Doppler effect + gravity) that weigh planets and stars also reveal the existence of an entirely new form of matter.
