...
<!-- FIGURE: module-3-concept-map (placeholder) — one-page visual of how this reading's ideas connect to the Module 3 spine: Hubble expansion (L24) + CMB + primordial abundances = three pillars of the Big Bang; BBN sets H/He; recombination → CMB; structure growth → cosmic web (L23) → galaxies (L22); stellar nucleosynthesis (Module 2) → the rest of the periodic table. -->
...
In 1964, Arno Penzias and Robert Wilson at Bell Labs were trying to use a horn antenna for radio astronomy. No matter which direction they pointed it, they picked up a persistent microwave hiss at about 3 K that would not go away. They cleaned the antenna. They evicted nesting pigeons. The hiss remained.
...
Before recombination, the universe was a plasma — free electrons and free nuclei (mostly protons and helium-4 nuclei). Photons scattered off the free electrons every few millimeters, so the universe was opaque, like the interior of a thick fog. No light could travel more than a short distance without being redirected.
...
::: {.callout-note title="Reference Box: The Three CMB Missions"}
...
::: {.callout-note title="The Universe's Temperature-Time Timeline"}
...
| $t = 0$ | — | ∞? | Initial singularity (?) |

*Higher rows = earlier, hotter, denser. We observe all the way back to recombination directly (via the CMB); earlier epochs we infer from their downstream consequences.*
:::
...
::: {.callout-note title="Why 25% Helium? A Back-of-Envelope Argument"}
...
::: {.callout-note title="Worked Example: The CMB Temperature Today"}
...
::: {.callout-note title="Deep Dive: The Horizon and Flatness Problems, and Why Inflation Helps" collapse="true"}
...
::: {.callout-note title="Deep Dive: The Sound of the Early Universe" collapse="true"}
...
::: {.callout-note title="Misconception: The Big Bang Was an Explosion Into Existing Space"}
...
::: {.callout-note title="Misconception: The CMB Is the Farthest Thing We Can See"}
...
::: {.callout-note title="Misconception: All the Elements Were Made in the Big Bang"}
...
::: {.callout-note title="Misconception: If the Universe Is Expanding, It Must Have a Boundary"}
