...
{{< fig seeing-the-past-infrared layout="aside" width="42%" >}}

The same idea powers "lookback time": when we observe very distant galaxies, we are not seeing them as they are now. We are seeing light that left when the universe was much younger, then was stretched into infrared wavelengths on its way to us.
...
When we measure the chemistry of pristine gas (e.g., the intergalactic medium, the atmospheres of ancient stars), we find it is roughly **75% hydrogen and 25% helium by mass**, with traces of deuterium, helium-3, and lithium-7. The hydrogen, helium, and deuterium abundances are major successes of Big Bang nucleosynthesis (BBN). Lithium-7 is the important caveat: standard BBN predicts a trace abundance, but old metal-poor stars show less lithium than expected. The honest claim is not "perfect match"; it is "multiple light-element abundances point to a hot, dense early universe, with one famous remaining tension." This is the topic of the last two major sections of this reading.
...
- **Primordial abundances** say the universe spent a specific window of time at temperatures of $\sim 10^9$ K in a radiation-dominated state, which matches the Big Bang model's first 3 minutes. By itself, it does not tell us about the universe on scales larger than nuclear physics.
...
- **The universe is very nearly uniform on large scales.** (Temperature is the same in every direction to 1 part in $10^5$.)
- **The universe has tiny initial density fluctuations.** (Those 1-in-$10^5$ variations encode the seeds of all later structure.)
...
|---------|-------|------------|-------------|
| COBE | 1989 – 1993 | ~$7^{\circ}$ | Confirmed blackbody spectrum ($T = 2.725$ K); discovered the 1-in-$10^5$ fluctuations (Nobel 2006) |
| WMAP | 2001 – 2010 | ~$0.2^{\circ}$ | Mapped the acoustic peaks; nailed $\Omega$-budget to ~5% |
| Planck | 2009 – 2013 | ~$0.08^{\circ}$ | High-precision cosmology: $H_0$, $\Omega_m$, $\Omega_\Lambda$, spectral index of initial fluctuations |
...
| ~380,000 yr | ~1100 | ~3000 K | **Recombination** — electrons + protons $\to$ H atoms; CMB released |
| ~50,000 yr | ~3400 | $\sim 10^4$ K | Matter-radiation equality |
| ~3 min | $\sim 10^8$ | $\sim 10^9$ K | **Big Bang nucleosynthesis** — H and He formed from p, n |
| ~1 sec | $\sim 10^9$ | $\sim 10^{10}$ K | Neutrino decoupling — the cosmic neutrino background |
| $\sim 10^{-6}$ sec | $\sim 10^{12}$ | $\sim 10^{12}$ K | Quark-gluon $\to$ hadron transition — protons and neutrons form |
| $\sim 10^{-12}$ sec | — | $\sim 10^{15}$ K | Electroweak symmetry breaking |
| $\sim 10^{-32}$ sec | — | $\sim 10^{27}$ K | End of inflation (cosmic exponential expansion) |
...
The leading model for the *very* early universe is **inflation**: a brief period of exponential expansion driven by an inflaton field, stretching a microscopic patch of space to a macroscopic scale in a fraction of a second. Inflation was proposed (Alan Guth, Andrei Linde, and others) in the 1980s to solve several puzzles — notably why the universe is so uniform (inflation stretched any initial non-uniformities beyond the horizon) and why it is geometrically flat. The quantum fluctuations of the inflaton field become the seed density perturbations that eventually grow into galaxies. Those perturbations are the same 1-in-$10^5$ bumps we see in the CMB.
...
The outcome after about 20 minutes (when the universe cooled below the nuclear-fusion threshold): roughly **75% hydrogen and 25% helium by mass**, with trace deuterium ($\sim 10^{-5}$), $^3$He ($\sim 10^{-5}$), and lithium-7 ($\sim 10^{-10}$). Every heavier element is absent. The universe has no carbon, no oxygen, no iron — and it will not for another ~200 Myr, when the first stars form and begin making them.

::: {.callout-worked-example title="Why 25% Helium? A Back-of-Envelope Argument" collapse="true"}
...
::: {.callout-worked-example title="Worked Example: The CMB Temperature Today" collapse="true"}
...
- **Big Bang (first 3 minutes):** H, He, trace deuterium, helium-3, and lithium. Lithium remains the one famous abundance tension.
- **Stellar fusion in main-sequence and giant stars:** C, N, O (via the CNO cycle and red-giant He burning).
- **Massive-star cores (> 8 $M_\odot$):** Many alpha and intermediate-mass elements, plus material up through the iron-group, via onion-shell burning before collapse.
- **Core-collapse supernovae:** Eject the progenitor's fusion products and synthesize additional elements in explosive burning. Some neutron-rich ejecta may contribute to lighter r-process elements, but core-collapse supernovae are not the whole heavy-element story.
- **Type Ia supernovae:** Major producers of iron-peak elements (Fe, Ni, Co) via thermonuclear runaway.
- **Neutron-star mergers:** A major confirmed site for many heavy rapid neutron-capture (r-process) elements — including gold, platinum, uranium, and other very heavy nuclei — supported by GW170817 (a gravitational-wave + electromagnetic binary neutron-star merger, 2017). Some r-process contributions from other sites remain under study.

{{< fig periodic-table-origins >}}

Every element on the periodic table has a cosmic origin story. Hydrogen and most helium are primordial. Carbon, nitrogen, and oxygen were made in stellar interiors. Iron comes from Type Ia SNe and core-collapse SNe. Much of the gold and uranium inventory points to neutron-star mergers and other neutron-rich r-process sites.

**Every atom in your body heavier than helium was made in a star, a stellar explosion, or a stellar-remnant merger.** The calcium in your bones was fused in the core of a massive star. The iron in your blood was expelled from supernovae. The heaviest trace elements in your body, such as iodine and molybdenum, come from neutron-capture processes in earlier generations of stars and stellar remnants, including neutron-star mergers and other sites still being studied.
...
::: {.callout-solution collapse="true" title="Answer"}
Answers vary by element. Carbon and oxygen are made mainly in stellar interiors; calcium and much iron are produced by supernovae, with Type Ia SNe especially important for iron-peak elements; iodine and many very heavy elements require neutron-rich environments such as neutron-star mergers and other r-process sites. The supporting evidence is not a single photograph: it is the combination of stellar-evolution models, spectra of stars and supernova remnants, gravitational-wave events such as GW170817, and the fact that Big Bang nucleosynthesis stops at H, He, and trace Li.
:::
:::
...
- **The horizon problem.** The CMB is uniform to ~1 part in $10^5$ in every direction. But regions of sky separated by more than $\sim 2^{\circ}$ have not, in standard Big Bang cosmology, had time to exchange information (light signals cannot have passed between them since the Big Bang). How did they end up the same temperature?
- **The flatness problem.** The universe is observed to be geometrically flat ($\Omega_{\text{total}} \approx 1$). But in a decelerating universe, any deviation from perfect flatness grows with time, so the early universe must have been *extraordinarily* close to flat — fine-tuned to approximately 1 part in $10^{60}$ at the Planck epoch (the exact figure depends on the extrapolation back to Planck-scale physics, but it is vanishingly small by any account). Why?
...
The pre-recombination plasma behaved as a fluid, and density perturbations in it oscillated as **sound waves**. These "baryon acoustic oscillations" are frozen in at the moment of recombination, leaving a characteristic angular scale in the CMB fluctuations — the famous **acoustic peaks** — and a characteristic distance scale in the galaxy distribution (the BAO standard ruler). Measuring the acoustic peaks and the BAO scale is how modern cosmology determines $\Omega_m$, $\Omega_\Lambda$, and $H_0$ with percent-level precision. The universe literally *rang* with sound waves for 380,000 years, and we can still hear the echo.
:::
...
At what temperature would you expect hydrogen to ionize (i.e., electrons escape from protons)? A useful reference: the Lyman-alpha transition has energy $\sim 10.2\ {\rm eV} \approx 13.6\ {\rm eV} \times 0.75$. Why does recombination happen at ~3000 K rather than at the temperature corresponding to $13.6\ {\rm eV}$?
...
- The **CMB** is the afterglow of recombination at $z \approx 1100$, when the universe cooled to ~3000 K and became transparent. Expansion has redshifted that 3000 K blackbody down to **2.725 K** today, with ~1-in-$10^5$ fluctuations encoding the seeds of all later structure.
- The CMB's acoustic-peak pattern pins down $\Omega_b \approx 5\%$, $\Omega_{\rm DM} \approx 27\%$, $\Omega_\Lambda \approx 68\%$ — independently confirming the L22 dark-matter inference and the L25 dark-energy result.
