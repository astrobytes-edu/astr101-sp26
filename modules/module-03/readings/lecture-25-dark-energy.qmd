...
learning-objectives:
  - Explain what a Type Ia supernova is, identify the white-dwarf progenitor, and describe the Chandrasekhar limit as the explosion trigger
  - Articulate why Type Ia SNe have a nearly universal peak luminosity and therefore serve as standard candles
...
A white dwarf is a stellar corpse held up by quantum-mechanical electron degeneracy pressure. If it ever grows past the **Chandrasekhar limit** (1.4 solar masses), it cannot support itself and detonates in a runaway thermonuclear explosion — a **Type Ia supernova**. Because every Type Ia explodes from (approximately) the same threshold mass, every Type Ia releases (approximately) the same peak luminosity. That makes them the brightest reliable standard candles in the universe, visible to billions of light-years. When we use them to build the Hubble diagram at high redshift, we find something no one expected: distant galaxies are *dimmer* than a decelerating expansion would predict. The universe is not slowing down. It is speeding up. Something is driving it — and we call that something **dark energy**.
:::
...
2. **Why is it a standard candle — specifically, why does every Type Ia release almost the same peak luminosity?**
...
**Goal after 20 minutes:** You should be able to describe the physical mechanism of a Type Ia supernova, explain why it is a standard candle, and articulate what dark energy is (and is not).
...
- [ ] I can describe the physical mechanism of a Type Ia supernova: a white dwarf accretes mass, crosses the Chandrasekhar limit, and undergoes runaway carbon-oxygen fusion.
- [ ] I can explain why the Chandrasekhar limit makes Type Ia peak luminosities nearly universal and thus standard-candle-like.
...
There are two main channels for a white dwarf to exceed the Chandrasekhar limit, both involving binaries:
...
2. **Double-degenerate channel:** Two white dwarfs in a close binary system spiral inward (via gravitational-wave emission, over ~Gyr) and eventually merge. The combined mass exceeds $M_{\text{Ch}}$.
...
In either case, the outcome is the same: the white dwarf's mass approaches $M_{\text{Ch}}$, the central density and temperature rise catastrophically, and carbon-oxygen fusion ignites at the core. Because degeneracy pressure is almost independent of temperature, the initial fusion does *not* cause the star to expand and cool (as it would in a normal star). Instead, the temperature skyrockets, fusion accelerates runaway, and the fusion front sweeps through the entire white dwarf in a few seconds. The star detonates — a **Type Ia supernova**.
...
::: {.callout-note title="Structure Reference Box: Type Ia vs. Type II"}

|   | Type Ia | Type II (core-collapse) |
|---|---------|-------------------------|
| Progenitor | White dwarf (~1.4 $M_\odot$) in binary | Massive star ($> 8 \, M_\odot$) |
...
Here is the cosmologically important fact: because every Type Ia explosion comes from a white dwarf *at (essentially) the same mass* ($M_{\text{Ch}} \approx 1.4 \, M_\odot$), and because the explosion mechanism converts a comparable fraction of that mass to nickel-56, **every Type Ia has (approximately) the same peak luminosity**. The intrinsic scatter is about 30 – 40%, and the **Phillips relation** further tightens this: brighter Type Ias have slower-decaying light curves, so the light-curve shape can be used to standardize the peak luminosity to about 7 – 10%.
...
This is the payoff of Lectures 20 and 23. The reason Type Ia SNe are standard candles is a stellar physics fact: the Chandrasekhar mass is a universal constant, set by the balance between electron degeneracy pressure and relativistic kinematics. Every white dwarf in the universe, no matter where it formed, obeys the same $M_{\text{Ch}}$. **The Chandrasekhar limit is the reason we can measure cosmology.** Stars are the rung we climb on — and this particular stellar rung stretches to the edge of the observable universe.
:::
...
::: {.callout-note title="The Ω-Budget"}
...
::: {.callout-note title="Worked Example: Pulling a Distance Out of a Type Ia Peak"}
...
At every rung that reaches beyond the Milky Way, the measurement is made with a specific kind of star. Lecture 25 is the payoff of Module 2: the Chandrasekhar limit, a stellar-structure result, is what makes Type Ia SNe standard candles, which is what tells us the universe is accelerating, which is what tells us dark energy exists. **Stars are the reason we know 68% of the universe is dark energy.**

---

## Deep Dives (Optional)

::: {.callout-note title="Deep Dive: How Nickel-56 Powers the Light Curve" collapse="true"}
...
::: {.callout-note title="Deep Dive: The Cosmological Constant Problem" collapse="true"}
...
::: {.callout-note title="Misconception: Dark Energy Is a Force"}
...
::: {.callout-note title="Misconception: All White Dwarfs Become Type Ia Supernovae"}
...
::: {.callout-note title="Misconception: Dark Energy Is the Same as Dark Matter"}
...
- A **Type Ia supernova** is a white dwarf pushed across the Chandrasekhar limit ($\approx 1.4\,M_\odot$) in a binary, detonating in runaway carbon-oxygen fusion. Because the progenitor mass is always ~$M_{\text{Ch}}$, the peak luminosity is nearly universal — a **standard candle**.
...
- The Chandrasekhar limit — a stellar-structure result from Module 2 — is the reason we know 68% of the universe is dark energy. **Stars anchor cosmology.**
:::
