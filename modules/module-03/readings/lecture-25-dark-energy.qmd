...
learning-objectives:
  ...
  - Describe dark energy as the inferred cause of acceleration and interpret the $\Omega$-budget of the universe (matter, dark matter, dark energy)
...
::: {.callout-key-insight title="Evidence Chain: Hidden Acceleration"}
...
- The 1998 Discovery and the $\Omega$-Budget
...
**Reference mode:** The Type Ia Mechanism Box and the $\Omega$-Budget Box are the long-term study references.
:::
...
This is the payoff of Lectures 20 and 23. The reason Type Ia SNe can be standardized is a stellar physics fact: white dwarfs are compact, degenerate carbon-oxygen objects with a narrow range of explosion conditions, and the Chandrasekhar mass provides the natural scale. **White-dwarf physics is the reason we can use Type Ias to measure cosmology.** Stars are the rung we climb on — and this particular stellar rung stretches deep into the cosmological universe.
:::

::: {.callout-check-yourself #cy-brightness-depth}
## Check Yourself 2: Type Ia Reach

A Type Ia supernova has peak luminosity $L \approx 5 \times 10^9 \, L_\odot \approx 2 \times 10^{36}\ {\rm W}$. If a modern survey can detect a flux of $F = 10^{-17}\ {\rm W\,m^{-2}}$, estimate the maximum distance (in Gpc) at which a Type Ia can be discovered.

::: {.callout-solution collapse="true" title="Answer"}
$d = \sqrt{L / (4\pi F)} = \sqrt{2 \times 10^{36} / (4\pi \times 10^{-17})}$ m $= \sqrt{1.6 \times 10^{52}}$ m $\approx 1.3 \times 10^{26}$ m.

Convert to Gpc: $1 \text{ Gpc} = 3.09 \times 10^{25}$ m, so $d \approx 4$ Gpc. This is a genuinely cosmological distance — far beyond Cepheids and large enough to probe how the expansion rate has changed over much of cosmic history. In real cosmology we would use luminosity distance rather than this flat inverse-square estimate, but the scale is the point.
:::
:::
...
{{< fig type-ia-dark-energy-hubble-diagram >}}
...
::: {.callout-roadmap title="Video: Accelerating Expansion" collapse="false"}
...
<div class="demo-embed" style="width: 100%; margin: 1rem 0;">
  <video
    controls
    preload="metadata"
    poster="https://svs.gsfc.nasa.gov/vis/a020000/a020200/a020246/WFirstExpansion_00599_print.jpg"
    style="width: 100%; border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; background: #0a0a14;">
    <source src="https://svs.gsfc.nasa.gov/vis/a020000/a020200/a020246/WFIRST_Dark_Energy_Expansion_H264_1080p.webm" type="video/webm">
    <source src="https://svs.gsfc.nasa.gov/vis/a020000/a020200/a020246/WFIRST_Dark_Energy_Expansion_H264_1080p.mov" type="video/quicktime">
  ...
  <p style="text-align: center; margin-top: 0.5rem; font-size: 0.875rem; color: #666;">
    <a href="https://svs.gsfc.nasa.gov/20246/" target="_blank" rel="noopener" style="color: #5dade2;">Open the NASA SVS source page in a new tab</a> (Credit: NASA's Goddard Space Flight Center Conceptual Image Lab)
  </p>
</div>
:::
...
::: {.callout-summary title="The Omega-Budget"}
...
### Worked Example: Type Ia Peak Magnitude to Distance

::: {.callout-worked-example title="Worked Example: Pulling a Distance Out of a Type Ia Peak" collapse="true"}
**Given:** A Type Ia supernova is observed at peak with flux $F = 5 \times 10^{-16}\ {\rm W\,m^{-2}}$. The (light-curve-corrected) peak luminosity of a Type Ia is $L_{\text{peak}} \approx 5 \times 10^9 \, L_\odot = 5 \times 10^9 \times 3.8 \times 10^{26}\ {\rm W} \approx 1.9 \times 10^{36}\ {\rm W}$.
...
- Rung 6: Hubble's law + $\Omega$-budget (cosmological)
...
A Type Ia supernova is observed at peak brightness with a flux of $F = 10^{-13}\ {\rm W\,m^{-2}}$. Using $L \approx 5 \times 10^9 \, L_\odot \approx 2 \times 10^{36}\ {\rm W}$, estimate the distance in Mpc.
...
- Type Ia SNe reach ~$5 \times 10^9 \, L_\odot$ at peak and are visible deep into cosmological distances. They are the fifth rung of the distance ladder and the tool that took the Hubble diagram to $z \sim 0.5 - 1$ in the 1990s.
...
- Acceleration requires an energy density with **negative pressure**: **dark energy**. Combined with the CMB (Lecture 26) and galaxy clustering (Lecture 23), this gives the cosmic $\Omega$-budget: ~5% baryons, ~27% dark matter, ~68% dark energy.
