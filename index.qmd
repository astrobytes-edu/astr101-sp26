...
3. Use the [Homework hub](homework/index.qmd) to find every released assignment and the linked reading solution pages.
4. Submit homework on [Canvas](https://sdsu.instructure.com) - readings and homework pages are on this website.
:::

::: {.callout-tip appearance="simple" icon=false}
## <i class="bi bi-stars"></i> Cosmic Playground — Interactive Demos
...
[<i class="bi bi-play-circle"></i> Launch Cosmic Playground](https://astrobytes-edu.github.io/cosmic-playground/){.btn .btn-primary} &nbsp; [Browse All Demos](demos/index.qmd){.btn .btn-outline-primary}
:::
...
::: {.dashboard-tile}
[<i class="bi bi-journal-check dashboard-tile-icon"></i>[Homework]{.dashboard-tile-title}](homework/index.qmd){.dashboard-tile-link}
:::
...
::: {.dashboard-tile}
[<i class="bi bi-play-circle dashboard-tile-icon"></i>[Demos]{.dashboard-tile-title}](demos/index.qmd){.dashboard-tile-link}
:::
